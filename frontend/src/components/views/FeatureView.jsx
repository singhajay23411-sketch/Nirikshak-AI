...
import HighRiskProjectsView from './HighRiskProjectsView';
...
const FeatureView = ({ featureId: propFeatureId, onBack }) => {
  ...
  const renderFeatureContent = () => {
    switch (featureId) {
      ...
      // ─────────────────────────────────────────────
      // 3. INVESTIGATION & RESOLUTION (DEDICATED SCREENS)
      // ─────────────────────────────────────────────
      ...
      case 'investigation':
        return (
          <HighRiskProjectsView
            onNavigateToEvidence={(projId) => {
              navigate('/features/evidenceReview?projectId=' + projId);
              window.scrollTo({ top: 0, left: 0, behavior: 'instant' });
            }}
          />
        );
        ...
        return (
          <EvidenceReviewView
            onNavigateToField={(projId) => {
              navigate('/features/fieldVerification?projectId=' + projId);
              window.scrollTo({ top: 0, left: 0, behavior: 'instant' });
            }}
          />
        );
      ...
      case 'fieldInspection':
        return (
          <FieldVerificationView
            onNavigateToResolution={(projId) => {
              navigate('/features/resolution?projectId=' + projId);
              window.scrollTo({ top: 0, left: 0, behavior: 'instant' });
            }}
          />
        );
